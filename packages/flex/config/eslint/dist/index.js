...
var index_js_1 = require("./partials/index.js");
module.exports = {
    env: {
        browser: true,
        es2021: true,
    ...
    rules: tslib_1.__assign({}, index_js_1.rules),
    settings: {
        react: {
            pragma: 'React',
            version: 'detect',
        ...
        'import/internal-regex': tslib_1.__spreadArray([], index_js_1.internalRegex, true),
    },
};
