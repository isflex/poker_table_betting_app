...
import {
  ...
  ToolbarSpace,
  View,
} from 'flex-design-system-react-ts/unstyled-module-components'
...
const App = (): JSX.Element => {
  ...
  return (
    <View className={'presentation-composant flexiness-root'}>
      {/*
       * ##############
       * TITRE
       * ##############
      ...
      <Section skeleton={skeleton}>
        ...
        <Button onClick={() => setSkeleton(!skeleton)} className='is-secondary'>
          {skeleton ? 'is-loaded' : 'is-loading'}
        </Button>
        <Divider />
        {Titles}

        <View className={`has-background-tertiary`}>{TitlesInverted}</View>
      </Section>
      {/*
       * ##############
       * BOUTON
      ...
      <Section>
        ...
        <Box markup={BoxMarkup.A} to='www.google.fr'>
          {' '}
          Box Cliquable - Lorem ipsum dolor sit amet, conseddvctetur adipiscing elit. Phasellus nec iaculis mauris.
        </Box>
...
<Divider />
      ...
      <Section>
        ...
        <Hero backgroundSrc={'https://picsum.photos/id/1/1500/600'}>
          <div className='container'>
            <p className='suptitle'>Message de bienvenue</p>
            <h1 className='title'>Bonjour Michel</h1>
      ...
      <Section>
        ...
        <MenuScrolling hasBackgroundWhite>
          <div className='field'>
            <Title level={TitleLevel.LEVEL5}>Miguel</Title>
          </div>
          <div className='field'>
            <Input placeholder='Rechercher' hasIcon search />
          </div>
          <Menu notASide className={'has-text-weight-bold'}>
      ...
      <Section>
        ...
        <Toolbar background={BackgroundStyle.WHITE}>
          <ToolbarGroup>
      ...
      <Section>
        ...
        <Section>
          <Notification title='Notification with button' arrow />
        </Section>{' '}
        <Section>
          <Notification title='Notification with button' info />
        </Section>{' '}
        <Section>
      ...
      <Section>
        ...
        <Footer fullwidth>
          <FooterDesktop fullwidth>
            <FooterWrapper>
              ...
              <FooterBody>
                ...
                <Columns>
                  <ColumnsItem>
                    <Text className='subfooter-title'>Forfait Mobiles 4G</Text>
                    <Link
                  ...
                  <ColumnsItem>
                    <Text className='subfooter-title'>Téléphones mobiles</Text>
                    <Link
                      className='subfooter-link'
                      removeLinkClass
                  ...
                  <ColumnsItem>
                    <Text className='subfooter-title'>Internet</Text>
                    <a
                      className='subfooter-link'
                      title='Box Internet'
                  ...
                  <ColumnsItem>
                    <Text className='subfooter-title'>Pourquoi nous choisir ?</Text>
                    <a
                      className='subfooter-link'
                  ...
                  <ColumnsItem>
                    <Text className='subfooter-title'>Bouygues Telecom</Text>
                    <a
                      className='subfooter-link'
          ...
          <FooterMobile>
            ...
            />
            <div className='has-text-white is-size-7 has-text-centered'>
              <p>Téléchargez lappli Espace Client</p>
              <div>
                <a
          ...
          <FooterSub>
            ...
            <div className='partners-icons is-hidden-touch'>
              ...
              <a title='Handicap Zero' href='https://www.handicapzero.org/telephonie/bouygues-telecom/'>
                <span className='icon handicapzero is-size-5'>
              ...
              <a title='Accessibilité de Bouygues Telecom' href='https://www.acce-o.fr/client/bouygues/'>
                <span className='icon accessibility is-size-5'>
          ...
          <PricingTable>
            ...
            <PricingPlan>
              ...
              <PricingPlanProduct hat>
                ...
                <PricingPlanHeader background={BackgroundStyle.WHITE}>
                  <Title>50Mo</Title>
                  <Text className='details'>Engagement 24 mois</Text>
                </PricingPlanHeader>
                <PricingPlanItems background={BackgroundStyle.WHITE}>
                  <PricingPlanPrice>
                    <Price
                      variant={PriceVariant.SECONDARY}
                      level={PriceLevel.LEVEL3}
          ...
          <Navbar newNavbar>
            <NavbarBrand>
              <NavbarItem markup={NavbarItemMarkup.A} hiddenTablet>
                <img
                  alt='Bouygues Telecom'
                  src='https://design.bouyguestelecom.fr/logo-bouygues-telecom.79081152.svg'
                />
              </NavbarItem>
              ...
              <div className='card-content'>
                <div className='rows'>
                  <div className='row'>
                    ...
                    <h3 className='title is-3'>Title lorem</h3>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ligula ex, aliquam at neque eu,
                      vulputate vera.
                    </p>
                  </div>
                  <div className='row is-narrow'>
                    <button className='button is-primary'>Button Lorem</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <Section>
        ...
        <Slice>
          ...
          <SliceContent>
            <Title level={TitleLevel.LEVEL6}>Slice avec CTA simple (ici, un simple chevron)</Title>
            <Text>Un texte supplémentaire pour décrire le contenu de laction</Text>
          </SliceContent>
          <SliceCta>
            <Icon name={IconName.UI_ARROW_RIGHT} size={IconSize.SMALL} onClick={() => alert('Click on cta')} />
          </SliceCta>
        </Slice>
