...
FLEX_IMAGE_REPOSITORY="registry.gitlab.com/isflex/poker_table_betting_app/linux_arm64/main"
FLEX_BRANCH="something"
FLEX_OUTPUT_LOC="registry"
FLEX_USER="isflex"
FLEX_HOME="/home/${FLEX_USER}"
FLEX_APP="${FLEX_HOME}/projects/${FLEX_SERVICE}"
FLEX_DOCKER_BUILDKIT_DEPTH=7
FLEX_DOCKER_PLATFORM="linux/arm64"
FLEX_CI_ARCH_TAG="linux_arm64"
FLEX_OS="linux"
FLEX_CPU="arm64"
FLEX_CI="true"
FLEX_PROTOCOL="http://"
